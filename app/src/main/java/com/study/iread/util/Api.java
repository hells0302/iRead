...
//    digest：首段
//    content：正文内容
    public static final String MEIRIYIWEN="https://interface.meiriyiwen.com/article/today?dev=1";
...
//
//    json 示例以及解析同每日一文
    public static final String MEIRIYIWENDAY="https://interface.meiriyiwen.com/article/day?dev=1&date=";
//    随机一文
//
//    url：https://interface.meiriyiwen.com/article/random?dev=1
//
//    json 示例以及解析同每日一文
    public static final String MEIRIYIWENRANDOM="https://interface.meiriyiwen.com/article/random?dev=1";
}
