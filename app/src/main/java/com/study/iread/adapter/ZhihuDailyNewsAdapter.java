...
public class ZhihuDailyNewsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<ZhihuDaily.Question> list = new ArrayList<ZhihuDaily.Question>();
    private OnRecyclerViewOnClickListener mListener;

    private static final int TYPE_NORMAL = 0;
    private static final int TYPE_FOOTER = 1;

    public ZhihuDailyNewsAdapter(Context context, List<ZhihuDaily.Question> list){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof NormalViewHolder) {
            ...
            ZhihuDaily.Question item = list.get(position);
